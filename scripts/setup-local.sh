...
ensure_env_file \
  "$ROOT_DIR/trip-rescue/.env.example" \
  "$ROOT_DIR/trip-rescue/.env"
...
ensure_venv "$ROOT_DIR/trip-rescue"
...
"$ROOT_DIR/trip-rescue/.venv/bin/python" -m pip install \
  -r "$ROOT_DIR/trip-rescue/requirements.txt"
